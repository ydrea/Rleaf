      ...
      try {
        ...
        const parsedData = response.data.map(item => {
          ...
          if (
            ...
            console.error(
              'Invalid JSON or missing coordinates:',
              geo
            );
            return null;
          }
    ...
    <div className="gallery">
      <section>
        ...
        <div className="kartxt">
          ...
          kolekciju georeferenciranih podataka koja vam omogućuje uvid
          u različite aspekte krajobraza. Upotrijebite alate za odabir
