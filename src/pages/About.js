        ...
        <div className="one">
          ...
          <ul style={{ textDecoration: 'none' }}>
            <li>
              ...
              <span>
                {' '}
                izvanredni profesor na Agronomskom fakultetu
                Sveučilišta u Zagrebu (UNIZG)
              </span>
            </li>
            <li>
              <p>dr.sc. Sanja Lončar</p>{' '}
              <span>
                izvanredna profesorica na Filozofskom fakultetu
                (UNIZG)
              </span>
            </li>
            <li>
      ...
      <section>
        ...
        <div className="three">
          <p>
            ...
            te se smatra da može generirati regeneraciju, rast i
            oporavak zajednice.
          </p>
          <p>
            {' '}
            Koncept krajobraza nosi sa sobom priču o tome da sav
            prostor oko nas zaslužuje održivi razvoj, ne samo onaj
            ...
            gubitku odnosa na relaciji čovjek – okoliš. Razumjeti
            danas krajobraz znači promatrati ga kroz različite
            prirodne, kulturno-povijesne, vizualne, materijalne i
            nematerijalne čimbenike.{' '}
          </p>
          <p>
            Primjenjivati krajobrazni pristup u nekom istraživanju,
            studiji, analizi znači pristupati prostoru integralno,
            dakle spajati znanja o različitim čimbenicima. Danas
            postoji niz metoda i alata koje nazivamo krajobraznim
            pristupom, prepoznati su na globalnoj razini, dio su
            paradigme održivog razvoja - ali imaju poteškoća sa
            ulaskom u sustav - u sektorske politike, zakonodavstvo.
            Zato se smatra da institucionalizacija tema krajobraza
            mora biti progresivna i znanstveno utemeljena.
          </p>{' '}
        </div>
      </section>
      <section>
      ...
      <section>
        <div className="five">
          <p>
            ...
            protokolima i politikama, odnosno monitoringu
            implementacije tema krajobraza.
          </p>{' '}
          <p>
            U Europi je sve više Opservatorija krajobraza, a najviše
            ih je u euromediteranskim regijama. Uspostavu
            ...
            Banovine/Banije), Republika Hrvatska, Ministarstvo kulture
