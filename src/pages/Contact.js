	...
	return (
		<div className='gallery'>
			<section>
				...
				<div className='un'>
					{' '}
					<p>Opservatorij krajobraza </p>
					<p>voditelj: izv.prof.dr.sc. Goran Andlar</p>
					<p> Sveučilište u Zagrebu, Agronomski fakultet </p>
					<p> Svetošimunska cesta 25 10000, Zagreb</p>
					<hr className='gren' />
					<p>
