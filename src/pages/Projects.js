  ...
  return (
    <div className="projects-container">
      <div className="tekst1">
        ...
        šireg programa Opservatorija, a njegova je svrha uspostava i
      ...
      <div className="tekst2">
        ...
        dokumentacije ugrožene drvene arhitekture kojeg provodi Oxford
        Brookes University iz Velike Britanije. Tim Opservatorija
        krajobraza, putem formalnog nositelja projekta: Društva Terra
        Banalis sa sjedištem u Glini, predložio je područje Banije,
        Posavine i Pokuplja na kojemu se nalazi najveća koncentracija
        povijesne drvene arhitekture u Hrvatskoj, koja je iz raznih
        razloga danas ugrožena. Kroz osvojenu programsku podršku će se
        tijekom 2023. i 2024. godine digitalno dokumentirati značajan
        broj naseobina i pojedinačnih objekata, vještina, znanja i
        umijeća vezanih uz obradu drveta i gradnju građevina od drvata
        te obiteljskih i osobnih priča vlasnika i graditelja drvenih
        kuća. Više o projektu možete pročitati na stranicama Društva
        Terra Banalis, a na interaktivnoj karti na stranicama
